...
public class Application {
    // here are  the lists that will hold entities
    ...
    private static void displayMenu() {
        ...
        System.out.println("3. Manage Administrators");
        // other menu options, etc.
    ...
    private static void manageAdministrators(Scanner scanner) {
        System.out.println("Manage Administrators");
        System.out.println("1. Add Administrator");
        System.out.println("2. View Administrators");
        System.out.print("Enter your choice: ");
